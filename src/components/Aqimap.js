...
const Aquimap = () => {
    ...
    return (
        <div className={"map_container d-flex flex-row fit-content"} >
            <div className="outer-box d-flex flex-row">
                <Map
                    {...points}
                    onMove={evt => setPoints(evt.viewState)}
                    style={{ width: "51%", height: "600px", borderRadius: "20px", boxShadow: "14px 14px 20px #000000, -14px -14px 20px #000000" }}
                ...
                <div className="container_box">
                    ...
                    <div className="inputs-form">
                        ...
                        <div className="d-flex justify-content-center">
                            <div className="brand-title-again">{backgroundImg}</div>
                        </div>
                    </div>
                </div>
            </div>
