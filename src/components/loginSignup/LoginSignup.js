        ...
        <div className="container-1" id="container-1">
            <div className="form-container-1 sign-up-container-1">
                <form className="signIn-form-tag" action="#">
                    ...
                    <div className="social-container-1">
                        ...
                        <a href="#" className="social signIn-a-tag"><i className="fab fa-facebook"></i></a>
                        <a href="#" className="social signIn-a-tag"><i className="fab fa-google-plus"></i></a>
                        <a href="#" className="social signIn-a-tag"><i className="fab fa-linkedin"></i></a>
                    </div>
            ...
            <div className="form-container-1 sign-in-container-1">
                <form className="signIn-form-tag" action="#">
                    ...
                    <div className="social-container-1">
                        <a href="#" className="social signIn-a-tag"><i className="fab fa-facebook-f"></i></a>
                        <a href="#" className="social signIn-a-tag"><i className="fab fa-google-plus-g"></i></a>
                        <a href="#" className="social signIn-a-tag"><i className="fab fa-linkedin-in"></i></a>
                    </div>
